...
El siguiente paso es revisar e integrar PR 3 de F6–F7. Después podrá solicitarse F8 por separado en `feature/dashboard`. Sigue pendiente decidir si las diferencias de mayúsculas del cliente deben ser equivalentes: la regla actual y su impacto observado se explican en SOLUCION. Resolver cada supuesto en su fase y dejar documentada la decisión si no hay confirmación comercial; nunca rellenar huecos con datos inventados.
